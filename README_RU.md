...
К примеру у синхронизации есть хук _rush_result_before соответственно в папке  /scripts/hooks/sync.sh/ при наступлении вызове события _rush_result_before будут искаться все файлы начинающиеся с _rush_result_before
